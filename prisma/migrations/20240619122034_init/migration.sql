...
-- AddForeignKey
ALTER TABLE "Update" ADD CONSTRAINT "Update_prodctId_fkey" FOREIGN KEY ("prodctId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
